export const en = {
   ...
   rating: {
      ...
      table: {
         ...
         pricePerMinute: "$ / min",
         license: "License",
         licenseOpen: "Open licence",
         licenseClosed: "Proprietary licence",
         sortRating: "Sort by rating",
         resizeColumn: "Resize column",
         loading: "Loading rankings…",
         emptyState: "No models to show",
      },
      about: {
         overview: {
...
export const ru: Dictionary = {
   ...
   rating: {
      ...
      table: {
         ...
         pricePerMinute: "$ / мин",
         license: "Лицензия",
         licenseOpen: "Открытая лицензия",
         licenseClosed: "Проприетарная лицензия",
         sortRating: "Сортировать по рейтингу",
         resizeColumn: "Изменить ширину колонки",
         loading: "Загрузка рейтинга…",
         emptyState: "Нет моделей для отображения",
      },
      about: {
         overview: {
