...
// Fields with no real-data equivalent (description, review/report counters)
// intentionally stay static placeholders shared by every row — see
// ModelRow's fallback lookup in provider.data.ts.
